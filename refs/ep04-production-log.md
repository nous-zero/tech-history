...
| 8 | 쇼츠 2종 | video-producer | 🔄 | `video/output/04_v2/shorts_A.mp4`·`shorts_B.mp4` | §6-3 완주 의무로 연속 진행 중(본선 지시, 완료 기준: 렌더+스펙 PASS+마커). **주의 2건**: ①IMG-05 사용 시 counsel 축약 확정 선행 ②쇼츠 BGM 내레이션 동반 필수(10항). 총감독 Monitor 재가동(쇼츠 마커 감시) |

...
10. **BGM 라이선스 이행 3종** — ①발행 직전 `hasYoutubeContentId` 재실측(신규 트랙이라 사후 등록 가능 — counsel 조건①) ②**RFC 3161 공인 타임스탬프 증빙 확인**(`refs/evidence/ep04-bgm/` — .tsr/.tsq 파일 실재 + 대장 기재. **Wayback은 실측 불가 확정으로 대체됨**, 2026-07-30) ③쇼츠는 내레이션 트랙 동반 필수(정지이미지+음악만 금지).

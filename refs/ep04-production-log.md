...
| 7 | 본편 렌더 | video-producer | 🔄 **1080p 진행** | `video/output/04_v2/episode.mp4` | 480p 초벌 통과(BGM 19.0 LU·길이 205.53s 일치·표본 9장). **seg13 수리 완료**(7ce5df0 — 문구 잘림+부수 결함 1건, 부분 재렌더 사진 검증, **그림자 구역 등록 일반 처방 4편 즉시 적용 — 구역 12개**). r8 감사에서 **seg12 캡션 2.70초 미달 발견 → counsel §17 면제 판정(11ee94a)** + 예외 등록부 `video/legal_caption_exceptions.json` 신설. 1080p 개시(본선 지시). **총감독 Monitor 가동**(스펙 리포트·오류 신호 감시) |

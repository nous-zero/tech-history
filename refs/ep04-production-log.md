...
| 7 | 본편 렌더 | video-producer | 🔄 | `video/output/04_v2/episode.mp4` | **개시 지시(13:1x)** — 480p 초벌(표본 육안+길이 불변식+BGM 믹스 -18~-22dB 실측) → 1080p 본렌더(~70분, --full 끝 spec 자동 호출). 청음 비차단 병렬. 기대 트랙 205.53s. bgm.py 첫 실전 |
